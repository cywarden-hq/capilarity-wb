                        ...
                        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-center">
                            <Reveal animation="slideLeft" duration="normal" delay={400}>
                                <div className="flex flex-col gap-6 lg:gap-10 p-6 lg:pl-20 order-2 lg:order-1">
                                    ...
                                    <div className="flex flex-col gap-4 lg:gap-5 text-[#64748B]">
                                        <span className="text-base lg:text-lg font-normal leading-relaxed">Capilarity provides you the root cause analysis of errors with detailed insights on affected pages, browsers, and users—so you can fix issues faster and keep your website performing at its best.
                                            We help you with faster detection and resolution of errors that affect the user experience of customers.</span>
                                        <span className="text-base lg:text-lg font-normal leading-relaxed">Get an in-depth understanding about how your website is really performing, how the users are interacting with your website and application. Track user journeys, analyze performance, and uncover data-driven insights to optimize digital experiences and keep customers engaged.</span>
                                        <span className="text-base lg:text-lg font-normal leading-relaxed">We provide you real time insights for your website and help you track website's performance and user experience with key metrics like response time, page load, and throughput.</span>
                                    </div>
                                </div>
                            </Reveal>
                            <img className="w-full max-w-md lg:max-w-full h-auto lg:h-full pl-6 mx-auto lg:mx-0 lg:hover:scale-101 lg:hover:-translate-x-1 transition-all duration-300 order-1 lg:order-2" src="/images/observability/service2.svg" alt="Service 2" />
                        </div>
                    </Reveal>
