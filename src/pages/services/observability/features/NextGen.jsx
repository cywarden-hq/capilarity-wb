                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 w-full">
                        ...
                        <Reveal animation="slideUp" duration="normal" delay={300}>
                            <div tabIndex={0} className="group bg-white rounded-xl p-8 relative overflow-hidden hover:shadow-2xl transition-all duration-500 ease-out cursor-pointer h-[250px]">
                                {/* Background Number */}
                                ...
                                {/* Main Content */}
                                <div className="relative z-10 transition-transform duration-500 ease-out group-hover:-translate-x-full group-focus:-translate-x-full">
                                ...
                                {/* Side Reveal Content */}
                                <div className="absolute inset-0 bg-orange-500 rounded-xl p-8 flex flex-col justify-center transform translate-x-[95%] transition-transform duration-1000 ease-out group-hover:translate-x-0 group-focus:translate-x-0 group-active:translate-x-0">
                        ...
                        <Reveal animation="slideUp" duration="normal" delay={500}>
                            <div tabIndex={0} className="group bg-white rounded-xl p-8 relative overflow-hidden hover:shadow-2xl transition-all duration-500 ease-out cursor-pointer h-[250px]">
                                ...
                                {/* Side Reveal Content */}
                                <div className="absolute inset-0 bg-orange-500 rounded-xl p-8 flex flex-col justify-center transform translate-x-[95%] transition-transform duration-1000 ease-out group-hover:translate-x-0 group-focus:translate-x-0">
                                    <p className="text-white leading-relaxed text-lg">
