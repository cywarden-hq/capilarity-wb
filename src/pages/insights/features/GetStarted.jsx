            ...
            <div className="flex flex-col gap-10 md:gap-20 rounded-2xl items-center justify-center py-6 md:py-10">
                ...
                <Reveal animation="slideUp" duration="normal" delay={200}>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 md:gap-20 w-full">
                        <div 
                            className="relative flex flex-col md:flex-row items-center justify-center w-full md:w-[40%] h-full bg-[#ededed] rounded-2xl md:rounded-3xl hover:scale-102 focus:scale-102 transition-all duration-300 ease-out cursor-pointer min-h-[300px] md:min-h-0"
                            onClick={() => navigate('/insights/post/grc-integration-cyber-resilience')}
                        >
                        ...
                        <div 
                            className="relative flex flex-col md:flex-row items-center justify-center w-full md:w-[60%] h-full bg-[#0b2d4d] rounded-2xl md:rounded-3xl hover:scale-102 focus:scale-102 transition-all duration-300 ease-out cursor-pointer min-h-[300px] md:min-h-0"
                            onClick={() => navigate('/insights/post/threat-modeling-frameworks')}
                        >
                            <div className="w-full md:w-[60%] flex flex-col p-6 md:p-0">
                                <div className="text-white px-4 md:px-6 py-1 bg-[#FF9D00] absolute top-4 left-0 rounded-tr-full rounded-br-full shadow-xl text-sm">CAPILARITY</div>
