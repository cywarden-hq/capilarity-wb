    ...
    <section className="bg-white w-full min-h-screen flex flex-col items-center justify-center px-8 py-20">
      ...
      <div className="max-w-6xl w-full space-y-14">
        ...
        <Reveal animation="slideRight" duration="normal" delay={200}>
          <div tabIndex={0} className="relative px-10 py-6 bg-[#fbfbfb] rounded-lg hover:bg-orange-50 shadow-lg shadow-orange-500/10 hover:shadow-orange-500/30 focus:bg-orange-50 focus:shadow-orange-500/30 transition-all duration-300 ease-out">
        ...
        <Reveal animation="slideLeft" duration="normal" delay={300}>
          <div tabIndex={0} className="relative px-10 py-6 bg-[#fbfbfb] rounded-lg hover:bg-orange-50 shadow-lg shadow-orange-500/10 hover:shadow-orange-500/30 focus:bg-orange-50 focus:shadow-orange-500/30 transition-all duration-300 ease-out">
            <p className="text-lg text-gray-800 leading-relaxed">
