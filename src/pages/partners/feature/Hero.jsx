...
export default function Hero() {
    return (
        <div className="relative w-full h-full lg:min-h-screen bg-[#010035] overflow-hidden">
            {/* Background Images */}
            <img
                src="/images/partners/hero_bg_left.svg"
                alt="Hero Background"
                className="absolute inset-0 w-full h-full object-cover"
            />
            <img
                src="/images/partners/hero_bg_right.svg"
                alt="Hero Background"
                className="absolute inset-0 w-full h-full object-cover"
            />
            ...
            <div className="relative z-20 text-white flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-60 py-20 sm:py-30 md:py-30 lg:py-40 xl:py-50 h-full lg:min-h-screen">
                ...
                <Reveal animation="slideLeft" delay={400} duration="normal" easing="elegant">
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl font-regular mb-4 sm:mb-6 md:mb-8 lg:mb-8 xl:mb-10 text-center max-w-4xl">
