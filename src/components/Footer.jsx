        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-[#CFCBCB] font-inter text-base hover:text-white transition-colors">About</a></li>
              <li><a href="#" className="text-[#CFCBCB] font-inter text-base hover:text-white transition-colors">Careers</a></li>
              <li><a href="#" className="text-[#CFCBCB] font-inter text-base hover:text-white transition-colors">LinkedIn</a></li>
              <li><a href="#" className="text-[#CFCBCB] font-inter text-base hover:text-white transition-colors">Blog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-[#CFCBCB] font-inter text-base hover:text-white transition-colors">Observability</a></li>
              <li><a href="#" className="text-[#CFCBCB] font-inter text-base hover:text-white transition-colors">AI Development</a></li>
              <li><a href="#" className="text-[#ACA7A7] font-inter text-base hover:text-white transition-colors">Managed DevOps</a></li>
              <li><a href="#" className="text-[#CFCBCB] font-inter text-base hover:text-white transition-colors">DevSecOps</a></li>
            </ul>
          </div>
        </div>
