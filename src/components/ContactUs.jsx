    ...
    <section className="relative w-full min-h-[300px] sm:min-h-[300px] lg:min-h-[500px] overflow-hidden bg-orange-50/50 border border-solid border-transparent px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          role="img"
          aria-label="Communication icons"
        >
          <img src={image_bottom_right} alt="Communication" className="w-full h-full object-contain" />
        </div>
        <div
          ...
          role="img"
          aria-label="Document or report illustration"
        >
          <img src={image_bottom_left} alt="Document" className="w-full h-full object-contain" />
        </div>
      </div>
